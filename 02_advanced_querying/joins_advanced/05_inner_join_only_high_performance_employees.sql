/*
EXERCISE 5 — Multi-Condition Join (Engineering High Reviews)

Goal:
Return only employees whose performance review have a score of 4 or higher. 

Requirements:
Include ONLY employees with a pr >= 4
- Return:
    - employee full name
    - department name
    - review_date
